...
function Deliveried() {
  ...
  return ( 
 <div class ="table1">
  <p class="qldh">Quản Lý <span>Đơn Đã Giao</span></p>
  <p class="ddh"><FontAwesomeIcon icon={faClipboardList}/> Quản lý đơn hàng  <FontAwesomeIcon icon={faAngleRight}/> Đơn đã giao</p>
<Table>
