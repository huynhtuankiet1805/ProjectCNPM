        ...
        <div class="container-fluid">
            <div className="row wrap-header">
                ...
                <div className="col-md-auto more">
                    <div className="btn-group">
                        ...
                        <ul className="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a href="#" className="dropdown-item aboutus">Về chúng tôi</a></li>
                            <li><a href="#" className="dropdown-item help">Hỗ trợ</a></li>
                        </ul>
                    </div>
                </div>
                <div className="col-xl-auto homeopt">
                    ...
                    <a href="#" className="aboutus">Về chúng tôi</a>
                    <a href="#" className="help">Hỗ trợ</a>
